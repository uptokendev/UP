...
export default function Hero({ children }: { children?: React.ReactNode }) {
  return (
    <section className="relative mx-auto mt-8 w-full max-w-6xl px-4">
      ...
      <div className="rounded-2xl border border-white/10 p-[1px] bg-gradient-to-br from-white/10 to-transparent">
        <div className="rounded-2xl bg-bg/80 p-6 md:p-10">
          <h1 className="text-3xl md:text-5xl font-semibold tracking-tight">
            Launch. Hold. <span className="bg-gradient-to-r from-cyan-300 to-fuchsia-400 bg-clip-text text-transparent">Go UP.</span>
          </h1>
  ...
  <button className="rounded-xl px-5 py-2 font-medium bg-gradient-to-r from-cyan-400 to-fuchsia-500 text-black">
    Buy $UP
  </button>
